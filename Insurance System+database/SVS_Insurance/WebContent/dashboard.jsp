...
<%
        List mylist = (List)request.getAttribute("totalagents");
        Iterator it = mylist.iterator();
         while(it.hasNext()) {%> 
            <div class="col-sm-6 col-lg-3" style="max-width: 32%">
                <div class="card text-white bg-flat-color-1">
                    <div class="card-body pb-0">
                        
                        <h4 class="mb-0">
                            <span class="count"><%=it.next()%></span>
                        </h4>
                        <p class="text-light">Total Agents</p>
        ...
        %> 
            <%
        List mylist2 = (List)request.getAttribute("totalclients");
            ...
            <div class="col-sm-6 col-lg-3" style="max-width: 32%">
                <div class="card text-white bg-flat-color-2">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
                            <span class="count"><%=it2.next()%></span>
                        </h4>
        ...
        %> 
            <!--/.col-->
<%
        List mylist3 = (List)request.getAttribute("totalpolicy");
            ...
            <div class="col-sm-6 col-lg-3" style="max-width: 32%">
                <div class="card text-white bg-flat-color-3">
                    <div class="card-body pb-0">
                        ...
                        <h4 class="mb-0">
                            <span class="count"><%=it3.next()%></span>
                        </h4>
                        <p class="text-light">Total Policys</p>
