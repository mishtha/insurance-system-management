<%-- 
    ...
    Created on : sep 2023, 7:37:06 PM
    Author     : Dharmishtha Patwariya
--%>
...
int pstatus=0;
 if(request.getAttribute("pstatus")!=null){
         pstatus=Integer.parseInt(request.getAttribute("pstatus").toString());
 }
%>
<!doctype html>
...
<body>
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="row">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                               ...
                               <%
                                   List mylist = (List)request.getAttribute("policylist");
                                   if(pstatus!=1){%>
                           <form action="addpolicyServlet" method="post" class="form-horizontal">
                         
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Policy Title</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="ptitle"  class="form-control"></div>
                          </div>
                            <div class="row form-group">
                            <div class="col col-md-3"><label for="select" class=" form-control-label">Policy Type</label></div>
                            <div class="col-12 col-md-9">
                              <select name="ptype" id="select" class="form-control">
                            ...
                            <div class="row form-group">
                            <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Policy Description</label></div>
                            <div class="col-12 col-md-9"><textarea name="pbody" id="textarea-input" rows="9" placeholder="Content..." class="form-control"></textarea></div>
                          </div>
        ...
        Iterator it = mylist.iterator();
         while(it.hasNext()) {%>  
                              <form action="editpolicyServlet" method="post" class="form-horizontal">
                         
                          <div class="row form-group">
                            
                              <div class="col-12 col-md-9"><input type="hidden" id="text-input" name="pid" value="<%=it.next()%>"  class="form-control"></div>
                          </div>
                                  
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Policy Title</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="ptitle"  value="<%=it.next()%>" class="form-control"></div>
                          </div>
                            <div class="row form-group">
                            <div class="col col-md-3"><label for="select" class=" form-control-label">Policy Type</label></div>
                            <div class="col-12 col-md-9">
                            ...
                            <div class="row form-group">
                            <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Policy Description</label></div>
                            <div class="col-12 col-md-9"><textarea name="pbody" id="textarea-input" rows="9" placeholder="Content..." class="form-control"> <%=it.next()%></textarea></div>
                          </div>
