...
<body>
    ...
    <aside id="left-panel" class="left-panel">
        ...
        <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="index.jsp"> <i class="menu-icon fa fa-dashboard"></i>Home</a>
                    </li><h3 class="menu-title">Actions</h3><!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>Client</a>
                        <ul class="sub-menu children dropdown-menu">
                ...
                <div class="row">
                    ...
                    <div class="card">
                         <div class="card-header">
                            <strong class="card-title">Client/Agent Users</strong>
                        </div>
                        <div class="card-body">
                            <table class="table">
                              ...
                              <tbody>
                                  <%
        List mylist = (List)request.getAttribute("userslist");
        Iterator it = mylist.iterator();
         while(it.hasNext()) {%>  
                                <tr>
                                    <th scope="row"><a href="http://localhost:8080/SVS_Insurance/userprofileServlet?uid=<%=it.next()%>"> <%=it.next()%></a></th>
                                  <td><%=it.next()%></td>
                                  <td><%=it.next()%></td>
                                  <td><a href="http://localhost:8080/SVS_Insurance/deleteuserServlet?uid=<%=it.next()%>"><i class="fa fa-bitbucket"></i> </a><a href="http://localhost:8080/SVS_Insurance/edituserServlet?uid=<%=it.next()%>"><i class="fa fa-edit"></i></a></td>
                                </tr>
                                <%}
        %>
                              </tbody>
