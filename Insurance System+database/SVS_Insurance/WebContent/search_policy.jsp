                ...
                <div class="row">
                    ...
                    <div class="card">
                      <div class="card-header">
                        <strong>Search Policy</strong>Here
                      </div>
                      <div class="card-body card-block">
                              ...
                              <form action="searchpolicyServlet" method="post" class="form-horizontal">
                         
                          <div class="row form-group">
                            
                              <div class="col-12 col-md-9"><input type="text" id="text-input" name="pid" placeholder="Policy ID" class="form-control"></div>
                          </div>
