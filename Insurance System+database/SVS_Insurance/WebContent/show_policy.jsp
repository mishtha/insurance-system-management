                ...
                <div class="row">
                    ...
                    <div class="card">
                         <div class="card-header">
                            <strong class="card-title">Life/Motor/Property Policies</strong>
                        </div>
                        <div class="card-body">
                            <table class="table">
                              ...
                              <tbody>
                                  <%
        List mylist = (List)request.getAttribute("policieslist");
        Iterator it = mylist.iterator();
         while(it.hasNext()) {%>  
                                <tr>
                                    <th scope="row"><%=it.next()%></a></th>
                                  <td><%=it.next()%></td>
                                  <td><%=it.next()%></td>
                                  <td><%=it.next()%></td>
                                  <td><a href="http://localhost:8080/SVS_Insurance/deletepolicyServlet?pid=<%=it.next()%>"><i class="fa fa-bitbucket"></i></a><a href="http://localhost:8080/SVS_Insurance/editpolicyServlet?pid=<%=it.next()%>"><i class="fa fa-edit"></i></a></td>
                                </tr>
                                <%}
        %>
                              </tbody>
