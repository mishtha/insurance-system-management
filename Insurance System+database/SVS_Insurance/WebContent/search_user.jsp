                ...
                <div class="row">
                    ...
                    <div class="card">
                      <div class="card-header">
                        <strong>Search User</strong>Here
                      </div>
                      <div class="card-body card-block">
                              ...
                              <form action="searchuserServlet" method="post" class="form-horizontal">
                         
                          <div class="row form-group">
                            
                              <div class="col-12 col-md-9"><input type="text" id="text-input" name="uid" placeholder="User ID" class="form-control"></div>
                          </div>
